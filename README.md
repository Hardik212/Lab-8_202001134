# Lab-8_202001134
## Name - Hardik P. Prajapati
## Student ID - 202001134
...
### 2. Test method for testing the behaviour of the Boa class : 
```
...
### 3. Updated setUp() method in the BoaTest class : 
```
public class BoaTest {
    private Boa jen;
    private Boa ken;
...
### 4. Updated testIsHealthy() method in the BoaTest class : 
```
@Test
public void testIsHealthy() {
...
### 5. Updated testFitsInCage() method in the BoaTest class : 
```
@Test
public void testFitsInCage() {
    // Test for jen
...
### 7. Here's the updated Boa class with the new lengthInInches() method:
```
public class Boa {
    private String name;
...
```
### The example of a new test case in the BoaTest class is given below which tests the lengthInInches() method:
```
...
```
This new test case checks that the lengthInInches() method returns the expected value when called on each of the Boa objects created in the setUp() method. It uses the assertEquals() method to compare the expected value to the actual value returned by the lengthInInches() method. The @Test annotation shows that this test method should be run by JUnit.
</br>
